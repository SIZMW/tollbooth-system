...
/**
 * The TollboothLogger implements a FIFO queue that only allows a message to be
 * added and removed from the queue. The implementation of the logger may vary
...
public interface SimpleLogger {
     ...
     *
     * @param message
     *            the LogMessage object to add to the queue
     */
