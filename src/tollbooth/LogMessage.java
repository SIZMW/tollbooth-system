...
/**
 * The LogMessage is a simple data structure that contains information about any
 * system malfunction.
 *
...
public class LogMessage {
     ...
     *            the descriptive message
     * @param cause
     *            the Throwable object, usually an Exception that was the cause
     *            for the message
     */
    ...
    /**
     * Returns if this log message has a throwable cause.
     *
     * @return true if the log message has a cause, false otherwise
     */
